...
class BootStrap {
    ...
    void createSampleData() {
        ...
        def account0 = new Account(username: "Admin", email: "admin@sellit.com", password: "password1", address: address1)
        account0.save(flush: true, failOnError: true)
        Role.list().each { Role role ->
            new AccountRole(account: account0, role: role).save(failOnError: true)
        }

        def account1 = new Account(username: "Mark", email: "mark@hotmail.com", password: "xxxx123", address: address1)
